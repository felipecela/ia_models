...
# ─────────────────────────────────────────────────────────────────────────────
# RUTAS DE MODELOS — Tabla de enrutamiento principal
# ─────────────────────────────────────────────────────────────────────────────
RUTAS: dict = {
    "CHAT": {
        ...
        "url": TABBYAPI_CHAT,
        "backend": "tabbyapi",
        "health_url": f"{TABBYAPI_URL}/health",
        "timeout_s": 60.0,
        "opciones_extra": {"temperature": 0.7, "max_tokens": 4096},
    },
    "INSTANTANEO": {
        ...
        "health_url": f"{TABBYAPI_URL}/health",
        "timeout_s": 30.0,
        "opciones_extra": {"temperature": 0.3, "max_tokens": 2048},
    },
    "AGIL": {
        "modelo": "llama-3.1-8b-awq",
        "url": SGLANG_CHAT,
        "backend": "sglang",
        "health_url": f"{SGLANG_URL}/health",
        "timeout_s": 120.0,
        "opciones_extra": {"temperature": 0.6, "max_tokens": 8192},
    },
    "PROFUNDO": {
    ...
    "CODIGO": {
        ...
        "health_url": f"{TABBYAPI_URL}/health",
        "timeout_s": 60.0,
        "opciones_extra": {"temperature": 0.2, "max_tokens": 4096},
    },
}
