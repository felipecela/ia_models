...
set -euo pipefail
SCRIPT_VERSION="V57"  # [V44-B1][V56-S1][V57] Versión del script — usada en banners y logs
...
if [[ "$_FLAG_STOP" == "true" ]]; then
    ...
    CONTAINERS=("ollama-gpu-main" "ollama-cpu-router" "exllamav2-api" "sglang-server" "swap-tabby-llama" "swap-tabby-qwen" "swap-sglang-awq" "chromadb" "obsidian-kb" "searxng" "openclaw-server")
