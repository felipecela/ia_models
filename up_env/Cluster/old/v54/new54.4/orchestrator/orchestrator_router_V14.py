...
║                                                                             ║
║ CORRECCIONES V22:                                                           ║
║   ✔ [V22-T1]  inject_thinking activado para phi4-reasoning:*               ║
║   ✔ [V22-T2]  check_tools convierte tools a texto plano (no las elimina)   ║
║   ✔ [V22-C1]  inject_opciones_extra: num_ctx=16384 para niveles GPU        ║
║   ✔ [V22-C2]  check_tools: corregido bug — devolvía None (ahora dict)      ║
║                                                                             ║
║ CORRECCIONES V23:                                                           ║
║   ✔ [V23-S1]  sanitize_for_ollama() llamado PRIMERO en la cadena de        ║
║               transformaciones del body, antes de inject_opciones_extra,   ║
║               inject_thinking y check_tools. Elimina stream_options,       ║
