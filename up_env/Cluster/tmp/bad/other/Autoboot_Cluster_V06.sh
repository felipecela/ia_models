#!/bin/bash
# ===== Archivo: Autoboot_Cluster_V6.sh =====
...
echo "[3/4] Inyectando credenciales y reglas de seguridad de red (V6)..."

# 1. Configuración de Modelos (Providers)
...
# 2. Configuración Core del Gateway (EL PARCHE MÁGICO DE RED)
# "bind": "lan" fuerza a que el puerto 18789 escuche hacia afuera (0.0.0.0)
...
echo "[4/4] Levantando contenedor de OpenClaw con puente LAN expuesto..."
docker run -d \
