#!/bin/bash
# ╔══════════════════════════════════════════════════════════════════════════════╗
# ║ OMEN AI Cluster — Autoboot V23                                             ║
# ║ RTX 4070 8GB · Intel Ultra 7 · 32GB RAM · SSD exFAT /mnt/ai_core          ║
# ╠══════════════════════════════════════════════════════════════════════════════╣
# ║ V23 — Correcciones sobre V22:                                              ║
# ║  ✔ [V23-D1] Red Docker: limpieza de bridges huérfanos antes de arrancar   ║
# ║             Detecta y elimina interfaces br-XXXX en state DOWN que        ║
# ║             compartan el subnet de ai_net (causa: ruta duplicada kernel    ║
# ║             que provoca RST / "no route to host" en ChromaDB y demás)     ║
# ╠══════════════════════════════════════════════════════════════════════════════╣
...
LOG_FILE="$LOG_DIR/autoboot_v23_$(date +%Y%m%d_%H%M%S).log"  # [V22-C9] renombrado, [V23-D1] bridge fix
...
# INICIO
# ═══════════════════════════════════════════════════════════════════════════════
section "OMEN AI Cluster — Autoboot V23"
...
# RESUMEN FINAL
# ═══════════════════════════════════════════════════════════════════════════════
section "Resumen del Cluster V23"
...
echo ""
echo -e "${GRN}${BLD}OMEN AI Cluster V23 — iniciado${NC}"
