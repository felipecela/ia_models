...
# ─────────────────────────────────────────────────────────────────────────────
# RUTAS DE MODELOS — Tabla de enrutamiento principal (V26: Solo Ollama GPU)
...
RUTAS: dict = {
    "CHAT": {
        ...
        "timeout_s": 60.0,
        "opciones_extra": {"temperature": 0.7, "max_tokens": 2048},
    },
    "INSTANTANEO": {
        "modelo": "phi4-mini:latest",
        "url": OLLAMA_GPU_CHAT,
        ...
        "health_url": f"{OLLAMA_GPU_URL}/api/tags",
        "timeout_s": 30.0,
        "opciones_extra": {"temperature": 0.3, "max_tokens": 1024},
    },
    "AGIL": {
        "modelo": "phi4:latest",
        "url": OLLAMA_GPU_CHAT,
        ...
        "health_url": f"{OLLAMA_GPU_URL}/api/tags",
        "timeout_s": 90.0,
        "opciones_extra": {"temperature": 0.6, "max_tokens": 4096},
    },
    "PROFUNDO": {
    ...
    "CODIGO": {
        ...
        "health_url": f"{OLLAMA_GPU_URL}/api/tags",
        "timeout_s": 90.0,
        "opciones_extra": {"temperature": 0.2, "max_tokens": 3072},
    },
}
